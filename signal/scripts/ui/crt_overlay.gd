...
func _ready() -> void:
	...
	if shader:
		...
		mat.set_shader_parameter("scanline_frequency", 500.0)
		mat.set_shader_parameter("vignette_intensity", 0.2)
		mat.set_shader_parameter("vignette_softness", 0.5)
		mat.set_shader_parameter("aberration_amount", 0.3)
		mat.set_shader_parameter("flicker_intensity", 0.005)
		mat.set_shader_parameter("noise_intensity", 0.01)
